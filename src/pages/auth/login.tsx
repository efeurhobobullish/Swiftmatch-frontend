  ...
  return (
    <div className="min-h-screen w-full flex bg-background text-main font-sans">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-24 relative">
        {/* Back Button */}
        <a href="/" className="absolute top-8 left-8 flex items-center gap-2 text-sm font-medium text-muted hover:text-primary transition-colors">
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                        ...
                        <input 
                            ...
                            placeholder="••••••••"
                            className="w-full h-12 pl-12 pr-12 bg-secondary/30 border border-line rounded-xl focus:border-primary focus:bg-background transition-all"
                            required
                        />
                        <button 
                            type="button"
